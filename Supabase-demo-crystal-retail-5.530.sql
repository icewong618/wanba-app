...
set
  ...
  products = jsonb_build_array(
    jsonb_build_object('id','retail-01','name','4.5Qt 空气炸锅','name_en','4.5Qt Air Fryer','category','小电器','description','无油热风烹饪，适合 2 至 4 人家庭。','description_en','Oil-free hot air cooking for 2 to 4 people.','price','$39.99','active',true,'image','https://images.unsplash.com/photo-1642163384651-76a93ce3bf4c?auto=format&fit=crop&w=900&q=82'),
    ...
    jsonb_build_object('id','retail-03','name','多功能电饭煲','name_en','Multi-Cooker Rice Cooker','category','小电器','description','煮饭、煲汤、蒸煮一机完成。','description_en','Rice, soup, steam, and more in one appliance.','price','$32.99','active',true,'image','https://images.unsplash.com/photo-1585238342028-4bbc8f749e2f?auto=format&fit=crop&w=900&q=82'),
    jsonb_build_object('id','retail-04','name','不锈钢电热水壶','name_en','Stainless Steel Electric Kettle','category','小电器','description','快速烧水，自动断电保护。','description_en','Fast boiling with automatic shutoff.','price','$16.99','active',true,'image','https://images.unsplash.com/photo-1520975958225-dff65859b00c?auto=format&fit=crop&w=900&q=82'),
    ...
    jsonb_build_object('id','retail-06','name','超声波加湿器','name_en','Ultrasonic Humidifier','category','小电器','description','卧室与办公桌适用，带柔和夜灯。','description_en','For bedrooms and desks, with a soft night light.','price','$22.99','active',true,'image','https://images.unsplash.com/photo-1602157162469-8a1f21e63d55?auto=format&fit=crop&w=900&q=82'),
    ...
    jsonb_build_object('id','retail-09','name','不粘锅三件套','name_en','3-Piece Nonstick Pan Set','category','厨房用品','description','常用煎锅尺寸组合，适合日常料理。','description_en','Everyday skillet sizes for home cooking.','price','$26.99','active',true,'image','https://images.unsplash.com/photo-1584990347449-a7f1a2f44b1f?auto=format&fit=crop&w=900&q=82'),
    ...
    jsonb_build_object('id','retail-11','name','玻璃保鲜盒 10 件套','name_en','10-Piece Glass Storage Set','category','厨房用品','description','耐热玻璃，适合备餐和冰箱收纳。','description_en','Heat-safe glass for meal prep and fridge storage.','price','$21.99','active',true,'image','https://images.unsplash.com/photo-1584346133934-a3afd7f6582f?auto=format&fit=crop&w=900&q=82'),
    jsonb_build_object('id','retail-12','name','竹制切菜板两件套','name_en','2-Piece Bamboo Cutting Board','category','厨房用品','description','双尺寸组合，轻巧耐用。','description_en','Two useful sizes, lightweight and durable.','price','$12.99','active',true,'image','https://images.unsplash.com/photo-1594385208974-2fa9b0a2a9c8?auto=format&fit=crop&w=900&q=82'),
    ...
    jsonb_build_object('id','retail-15','name','水槽收纳整理架','name_en','Sink Organizer Caddy','category','厨房用品','description','海绵、清洁刷和洗洁精一处收纳。','description_en','Keeps sponges, brushes, and soap together.','price','$8.99','active',true,'image','https://images.unsplash.com/photo-1583845112203-454cbb4b5f2c?auto=format&fit=crop&w=900&q=82'),
