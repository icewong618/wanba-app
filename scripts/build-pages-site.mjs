...
const directories = ['assets', 'shared', 'i18n', 'deals', 'week', 'messages', 'restaurant', 'rental', 'autos', 'booking', 'events', 'tickets', 'services', 'merchant', 'shop', 'shipping', 'retail', 'inventory', 'order', 'vendor'];
