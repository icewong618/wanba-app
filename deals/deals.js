(() => {
  ...
  const top = () => `<header class="module-top"><button onclick="Deals.back()" aria-label="返回">‹</button><b>今日省钱</b><button onclick="Deals.refresh()" aria-label="刷新">↻</button></header>`;
