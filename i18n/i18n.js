(() => {
  ...
  Object.assign(packs.en, {
    '语言':'Language','消息':'Messages','评论和@':'Comments & Mentions','新增粉丝':'New Followers','赞和收藏':'Likes & Saves','私信':'Direct Messages','登录后查看消息':'Sign in to view messages','暂无私信 · 在帖子页可私信作者':'No messages yet. You can message an author from a post.','还没有评论或@':'No comments or mentions yet','还没有新粉丝':'No new followers yet','还没有赞和收藏':'No likes or saves yet','查看笔记':'View Post','回关':'Follow Back','已关注':'Following','互相关注':'Mutual Follows','关注':'Follow','请先登录':'Please sign in first','返回':'Back','关闭':'Close','刷新':'Refresh','正在读取今日优惠...':'Loading today’s deals...','正在读取菜单...':'Loading menu...','正在读取排队信息...':'Loading waitlist...','正在打开商家管理后台...':'Opening merchant dashboard...','正在打开租车管理...':'Opening rental management...'
  });
